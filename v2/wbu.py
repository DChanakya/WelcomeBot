...
##    app1=Tk()
    def __init__(self, parent, controller):
        ...
        #------------------------------------------------------------------------------#
         ...
         e1.pack(side="top",ipady=15,pady=15)
         label = tk.Label(self, text="PHONE NUMBER:", font=controller.title_font)
         label.pack(side="top",padx=2, pady=1)
         e2 = tk.Entry(self,font=controller.title_font)
         e2.pack(side="top", ipady=15,pady=15)
         label = tk.Label(self, text="LOCATION:", font=controller.title_font)
         label.pack(side="top",padx=2, pady=1)
         e3 = tk.Entry(self,font=controller.title_font)
         e3.pack(side="top",ipady=15,pady=15)
