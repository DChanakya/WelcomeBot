...
while 1:
    ...
    if(IO.input(16)==True and IO.input(18)==False): #both while move forward     
        print("Condition 1")
        IO.output(32,True) #1A+
        IO.output(36,False) #1B-
        IO.output(38,True) #2A+
        IO.output(40,False) #2B-
    elif(IO.input(16)==True and IO.input(18)==True): #turn right  
        print("Condition 2")
        IO.output(32,True) #1A+
        IO.output(36,True) #1B-
        IO.output(38,True) #2A+
        IO.output(40,False) #2B-
    elif(IO.input(16)==False and IO.input(18)==False): #turn left
        print("Condition 3")
        IO.output(32,True) #1A+
        IO.output(36,False) #1B-
        IO.output(38,True) #2A+
